...
CREATE TABLE IF NOT EXISTS `CADMUS_db`.`reports` (
  ...
  `medics_uid` INT NOT NULL,
  PRIMARY KEY (`report_id`),
  INDEX `fk_reports_medics1_idx` (`medics_uid` ASC) VISIBLE,
  CONSTRAINT `fk_reports_medics1`
    FOREIGN KEY (`medics_uid`)
    REFERENCES `CADMUS_db`.`medics` (`medic_uid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
